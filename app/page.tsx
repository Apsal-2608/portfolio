    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-xs md:text-sm">
                ...
                <p className="text-[11px] text-slate-400">
                  System Administration · Networking · Cloud · Cybersecurity
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto flex max-w-6xl flex-col-reverse items-center gap-10 px-5 md:flex-row md:px-8">
            ...
            >
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-500/5 px-3 py-1 text-xs font-medium text-emerald-300 shadow-[0_0_25px_rgba(16,185,129,0.45)]">
                ...
                Open to Work · System Administration · Networking · Cloud · Cybersecurity
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm font-medium uppercase tracking-[0.16em] text-cyan-300/90">
                  System Administration · Networking · Cloud · Cybersecurity Student · Madurai, India
                </p>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  ...
                  Available for system administration, networking, cloud & cybersecurity roles
                </a>
              </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 text-xs text-slate-300 sm:flex sm:flex-wrap">
                ...
                <div className="flex items-center gap-2 rounded-full border border-slate-700/70 bg-slate-900/50 px-3 py-1.5">
                  ...
                  <span>6 Months System Administration Experience</span>
                </div>
                <div className="flex items-center gap-2 rounded-full border border-slate-700/70 bg-slate-900/50 px-3 py-1.5">
                  <Cpu className="h-4 w-4 text-cyan-300" />
                  <span>Networking & IT Automation Projects</span>
                </div>
              </div>
            </motion.div>
        ...
        <Section id="about" title="About Me" eyebrow="Who I am & what I do">
          <div className="grid gap-8 md:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)]">
            <div className="space-y-4 text-sm leading-relaxed text-slate-300 md:text-base">
              <p>
                I&apos;m a System Administrator with 6 months of hands-on experience supporting
                Windows systems, hardware, peripherals, workstation issues, and internal IT
                operations. My day-to-day work includes LAN connectivity, IP configuration,
                DHCP-related troubleshooting, system configuration, and hardware diagnostics.
              </p>
              <p>
                My technical foundation spans TCP/IP, subnetting, routing, switching, VLANs,
                Linux, Wireshark, Cisco Packet Tracer, network security, vulnerability assessment,
                and web security testing. I&apos;m also building my cloud knowledge across AWS and
                Azure fundamentals.
              </p>
              <p>
                I enjoy turning repetitive IT tasks into practical automation. My projects include
                an office IT inventory system, network-based activity monitoring, a web vulnerability
                scanner, AI-based network automation, and an enterprise network simulation.
              </p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2.5 text-xs text-slate-200">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-slate-50">System Administrator – 6 months</strong> at
                      Swift Prosys Pvt. Ltd., supporting Windows systems, hardware and internal IT.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 rounded-full bg-purple-400 shadow-[0_0_10px_rgba(168,85,247,0.9)]" />
                    <span>
                      <strong className="text-slate-50">Networking & infrastructure</strong> –
                      TCP/IP, DHCP, routing, switching, VLANs, troubleshooting and packet analysis.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.9)]" />
                    <span>
                      <strong className="text-slate-50">Automation mindset</strong> – Python-based
                      IT inventory, LAN discovery, system information collection and Excel automation.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <Section
          id="experience"
          title="Experience"
          eyebrow="Professional experience & practical exposure"
        >
          <div className="grid gap-6 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
            ...
            >
              ...
              <p className="mt-1 text-sm text-slate-100">Swift Prosys Pvt. Ltd.</p>
              <ul className="mt-4 space-y-2.5 text-sm leading-relaxed text-slate-300">
                <li>• Provide day-to-day technical support for Windows systems, hardware, peripherals and employee workstations.</li>
                <li>• Troubleshoot LAN connectivity, IP configuration, DHCP-related issues and common network problems.</li>
                <li>• Perform PC hardware installation, maintenance, diagnostics and preventive troubleshooting.</li>
                <li>• Support system configuration, software setup, user-side troubleshooting and workstation maintenance.</li>
                <li>• Develop internal automation solutions to improve IT asset visibility and monitor network-connected systems.</li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <p className="mt-1 text-sm text-slate-100">ShadowFox · 1 Month</p>
              <p className="mt-3 text-sm text-slate-300">
                Practical exposure to cybersecurity fundamentals, security labs, vulnerability
                assessment and real-world style exercises, complementing my system administration
          ...
          <div className="grid gap-8 md:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <p className="text-[11px] text-slate-400">
                  For direct opportunities, please use email or LinkedIn below.
                </p>
              </div>
            </motion.form>
        ...
        <footer className="border-t border-slate-800/70 bg-slate-950/80 py-6 text-xs text-slate-400">
          <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-5 text-center md:flex-row md:px-8 md:text-left">
            <p>© 2026 Mohamed Apsal – System Administration · Networking · Cloud · Cybersecurity</p>
